...
func Xgo() error {
	...
	return mageextras.Xgo(
		...
		image,
		"-targets",
		"darwin/amd64,darwin/arm64,linux/386,linux/amd64,linux/arm,linux/arm64,linux/loong64,linux/mips,linux/mips64,linux/mips64le,linux/mipsle,linux/ppc64,linux/ppc64le,linux/riscv64,linux/s390x,windows/amd64",
		".",
	)
}
